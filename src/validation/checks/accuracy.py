...
def check_accuracy(df: pd.DataFrame) -> dict[str, Any]:
    ...
    if "Type" in df.columns:
        ...
        checks.append({
            "check": "Type in {A, B, C}",
            "column": "Type", "type": "set_membership",
    ...
    if "IsHoliday" in df.columns:
        ...
        checks.append({
            ...
            "column": "IsHoliday", "type": "set_membership",
    ...
    if "Sales_Class" in df.columns:
        ...
        checks.append({
            ...
            "column": "Sales_Class", "type": "target_validity",
    ...
    if "Weekly_Sales" in df.columns:
        ...
        checks.append({
            ...
            "column": "Weekly_Sales", "type": "domain_flag",
